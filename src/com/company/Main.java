/**This code is developed by: Aqila Nasity
 * Section B , Dep SE
 */
package com.company;
...
class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            do
            {                                                                        //while input is not a positive integer, asks for input
            ...
            scan.nextLine();
            do
            {                                                                            //while length of pages[] array is not equal to n, asks for input
